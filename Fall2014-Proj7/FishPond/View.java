...
public class View extends JPanel {
	...
	public View(Model model, int rows, int cols, int rockCount, int fishCount, 
		...
		frame = new JFrame("Fish versus Plants II: Revenge of the Plants");
	 ...
	 */
	public int getRockCount(){return Integer.valueOf(rockCountField.getText());}
	
	/**
	 * Return the value of the "fish" field entered by the user into the GUI
	 */
	public int getFishCount(){return Integer.valueOf(fishCountField.getText());}
	
	/**
	 * Return the value of the "plants" field entered by the user into the GUI
	 */
	public int getPlantCount(){return Integer.valueOf(plantCountField.getText());}
