...
public class SquareGrid extends JPanel{
	...
	public int getScale(){return scaleH;}
	public int getHt(){return scaleH;}
	public int getWd(){return scaleW;}
	...
	private void createAndShowFrame(){
		...
		setSize((scaleW+2*MARGIN_SIZE)*SQUARE_SIZE, (scaleH+2*MARGIN_SIZE)*SQUARE_SIZE);
	...
	public Dimension getPreferredSize(){
		return new Dimension((scaleW+2*MARGIN_SIZE)*SQUARE_SIZE+1, (scaleH+2*MARGIN_SIZE)*SQUARE_SIZE+1);
	}
